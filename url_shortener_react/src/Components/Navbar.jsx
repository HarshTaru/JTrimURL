...
const Navbar = () => {
    // Redirect handler if no auth token
            ...
            <div className="flex justify-between items-center h-16 px-0 sm:px-4 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        className="hidden md:inline-block font-semibold bg-black text-white px-4 py-2 rounded-md hover:bg-gray-900 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-900"
                        type="button"
