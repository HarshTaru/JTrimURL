  ...
  const redirectIfNoAuth = (e) => {
    ...
    return (
        <section className="pt-24 pb-20 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6 text-gray-900 select-none">
                Simplify Your Links with JTrimURL
            </h1>
            <p className="text-gray-500 text-lg md:text-xl mb-10 max-w-3xl mx-auto">
